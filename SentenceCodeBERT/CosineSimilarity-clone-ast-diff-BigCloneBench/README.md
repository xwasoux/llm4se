...
2. es-train.txt/es-valid.txt/es-test.txt provide examples, stored in the following format:    idx1	idx2	label(0/1)   edit_script   cosine_label
...
python3 run.py \
    ...
    --train_data_file ../dataset/es-train.txt \
    --valid_data_file ../dataset/es-valid.txt \
...
python3 run.py \
    ...
    --index_data_file ../dataset/data.jsonl \
    --test_data_file ../dataset/es-test.txt \
    --do_test \
